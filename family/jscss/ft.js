...
(async () => {
  const cont = document.querySelector("#FamilyChart"),
    ...
    Card = f3.elements.Card({
      ...
      link_break: false,
      cardEditForm,
      addRelative: f3.handlers.AddRelative({store, cont, card_dim, cardEditForm, labels: {mother: 'Мать'}}),
    }),
...
function firstNode() {
  return [{id: '0', rels: {}, data: {'first name': 'Enter password', 'last name': "", 'birthday': "",
      avatar: "", gender: "M"}}]
}
